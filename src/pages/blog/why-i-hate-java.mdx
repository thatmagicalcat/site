...
java not only made that mistake, but literally married it, gave it to the type system, threw it into every object ref by default so that it can ambush you with `NullPointerException` after line you write.
